...
To add the header or slider to any page, select the Header Page template (particularly helpful when selecting a static front page).
...
Menu
The drop down menu now goes two levels deep. The uneven edges of the pull down boxes are now even.

On iPhones and iPads, the entire menu would disappear when the user scrolled up on any page--this has been fixed.
